...
export default function WorksheetForm({ onSubmit }: WorksheetFormProps) {
  ...
  return (
    <div className="w-full py-[24px] worksheet-form-container">
      <Card className="bg-white shadow-sm">
        <CardContent className="p-8">
          <form onSubmit={handleSubmit}>
            <div className="mb-6">
              <div className="flex justify-between items-start mb-6">
                <h1 className="text-3xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-pink-500 via-violet-500 to-blue-500">
