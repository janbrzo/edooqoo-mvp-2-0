...
// Fixed exercise times based on your exact specifications
  ...
  const timeMap = {
    '45min': {
      withGrammar: { // 45min total: 5 warmup + 10 grammar + 30 exercises = 45min
        ...
        'dialogue': 6,
        'true-false': 3,
        'discussion': 0, // Not used in 45min with grammar
        'error-correction': 0 // Not used in 45min with grammar
      },
      withoutGrammar: { // 45min total: 5 warmup + 0 grammar + 40 exercises = 45min
        ...
        'dialogue': 8,
        'true-false': 5,
        'discussion': 0, // Not used in 45min without grammar
        'error-correction': 0 // Not used in 45min without grammar
      }
    },
    '60min': {
