...
-- Update consume_token to increment monthly_worksheets_used also when consuming available_tokens,
-- excluding the first two lifetime "demo" worksheets (unless subscription is active)
